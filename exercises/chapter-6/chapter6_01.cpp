...
/*
    This code represents the final version of the chapters drills. It
    only differs slightly from the code found within the chapter folder.

    TO-DO: Find a way to pass the '!' token to the main() function to factorialize the previous value.
